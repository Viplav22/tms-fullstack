  ...
  return (
    <div>
      <Jumbotron style={{ backgroundColor: '#333' }} className="text-center">
        ...
        <CardDeck>
          <Card>
            <CardImg top width="100%" height="300px" src="https://i.pinimg.com/originals/5f/8d/e8/5f8de8ccdf8c63c081347690ce87b3ce.png" alt="Card image cap" />
            <CardBody>
          ...
          <Card>
            <CardImg top width="100%" height="300px" src="https://i.pinimg.com/originals/d4/30/1c/d4301c6b1ff43529fd646fe49166e9e1.jpg" alt="Card image cap" />
            <CardBody>
          ...
          <Card>
            <CardImg top width="100%" height="300px" src="https://i.pinimg.com/736x/3f/aa/04/3faa04682ec48de810f1260988847aab.jpg" alt="Card image cap" />
            <CardBody>
